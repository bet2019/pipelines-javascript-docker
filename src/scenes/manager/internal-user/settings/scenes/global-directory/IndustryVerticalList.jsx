...
class IndustryVerticalList extends React.Component {
  
  render() {
    const scope = 'industryVertical'
    return (
      <Can I="do" a="acl:settings/manage">
        <PageTitle title="Industry verticals">
...
export default connect()(IndustryVerticalList);